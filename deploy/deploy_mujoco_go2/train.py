...
def train_sac(go2_cfg, terrain_cfg, total_timesteps=20000, model_path="sac_model.zip"):
    trainer = TerrainTrainer(go2_cfg, terrain_cfg)
    env = TerrainGymEnv(trainer, max_episode_steps=200)
...
if __name__ == "__main__":
    ...
    train_sac(go2_cfg, terrain_cfg, total_timesteps=20000, model_path=model_path)
