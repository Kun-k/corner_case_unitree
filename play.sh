...
python legged_gym/scripts/play.py --task=go2_stair --experiment_name go2_stair_exp --num_envs 16 --seed 42 --max_iterations 10 --sim_device cuda:0 --rl_device cuda:1
