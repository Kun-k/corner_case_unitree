...
python legged_gym/scripts/train.py --task=go2_stair --experiment_name go2_terrain_4_exp --run_name go2_terrain_4_exp_0 --num_envs 4096 --seed 42 --max_iterations 10000 --sim_device cuda:2 --rl_device cuda:1
